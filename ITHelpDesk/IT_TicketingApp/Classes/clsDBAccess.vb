...
Public Class clsDBAccess
   ...
   Dim chkQry As Integer
    ...
    Public Function InsertProc_GetLastComplainID(ByVal ProcName As String, ByVal Par(,) As String)
        Try
            objCon.Open()
            ...
            cmd.ExecuteNonQuery()
            Dim lastComplainID = cmd.Parameters("@ComplainID").Value.ToString()
    ...
    Public Function InsertProc_ComplaintHistory(ByVal ProcName As String, ByVal Par(,) As String)
        Try
            objCon.Open()
    ...
    Public Function InsertProc_TDMCustomer(ByVal ProcName As String, ByVal Par(,) As String)
        Try
            objCon.Open()
            ...
            For i As Int16 = 0 To UBound(Par)
                If i = 0 Then
                    cmd.Parameters.Add(New SqlParameter("@TDM_Order_ID", SqlDbType.BigInt))
                    cmd.Parameters("@TDM_Order_ID").Direction = ParameterDirection.Output
                    cmd.Parameters.AddWithValue(Par(i, 0), Par(i, 1))
            ...
            cmd.ExecuteNonQuery()
            Dim InsertedID = cmd.Parameters("@TDM_Order_ID").Value.ToString()
            Return InsertedID
